# Phase 10 farm5 0.1.134 sync/test evidence

command:
  sudo mpf-sync-main-zip /tmp/proxy-address-mining-main.zip

backup:
  /var/backups/mpf/source-before-zip-sync-20260518T074035Z

server version after sync:
  0.1.134

pytest:
  776 passed in 140.42s (0:02:20)
...
Phase 10 readiness evidence:
  ...
  share-timeline-model-readiness: ACCEPTED
  collector-dry-run-gate-readiness: ACCEPTED
  collector-dry-run-plan: ACCEPTED
  blockers: []
  warnings: []
  errors: []
