...
Phase 11 planning/readiness note (0.1.212): fixed current phase safety gate expected-version drift by deriving the artifact gate expected version from VERSION while keeping all production/miner/activation gates closed.
