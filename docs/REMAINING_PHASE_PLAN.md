...
- Repository version after this PR is 0.1.208.
...
- after 0.1.208 sync and full pytest, next intended farm5 step is long-lived external Stratum + runtime evidence collection/classification for 20101.
