...
Phase 11 controlled artifact reapply fix note (0.1.250): executor CI checks now honor injected empty environment mappings so drift tests and service-layer preflight are not masked by ambient CI variables; no farm5 mutation was performed and Phase 12/worker enforcement/UI/Telegram remain blocked.
