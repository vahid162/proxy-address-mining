...
`docs/AI_PHASE_8_TASK.md` is historical/accepted. `docs/AI_PHASE_9_TASK.md
- docs/AI_PHASE_10_TASK.md` is active/current. Phase 6 documents below are historical/reference-only and non-authorizing.
