...
Do not change the official PR class taxonomy; governance-documentation is only for completed CI/template/validator/AI-governance/documentation-contract work and must not be used for runtime/evidence work or to bypass active runtime-first work; approximate classes such as docs/evidence-only, test-only, and refactor-only are forbidden.
