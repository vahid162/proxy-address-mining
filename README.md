...
Historical compatibility anchor: Latest recorded farm5 sync evidence is 0.1.128. Current target is Phase 10 planning/readiness. fresh farm5 0.1.129 sync/test evidence. This is stale/non-authorizing historical Phase 7/9/10 context only and not production activation; current authoritative evidence remains 0.1.136 and current work remains Phase 11 planning/readiness.
