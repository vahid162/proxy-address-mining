...
class FirewallGateReviewReport:
    ...
    restore_lock_record_acceptance_gate_summary: dict[str, Any] = field(default_factory=dict)
    restore_lock_record_execution_gate_summary: dict[str, Any] = field(default_factory=dict)
