...
def build_worker_policy_readiness_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
    report = build_phase10_readiness_report(cfg, repo_root=repo_root)
    return {
        "component": "phase10_worker_policy_readiness_service",
        "final_decision": report["final_decision"],
        "authorization_status": report["authorization_status"],
        "execution_allowed": report["execution_allowed"],
        "worker_policy_readiness": report["worker_policy_readiness"],
