...
def build_phase8_controlled_worker_dry_run_report(cfg: MPFConfig, repo_root: Path | None = None, *, operator_confirmed: bool = False, batch_limit: int = 5) -> dict[str, object]:
    ...
    result = evaluate_controlled_worker_dry_run(ControlledWorkerDryRunInput(
        repository_version=__version__, latest_recorded_farm5_sync_evidence="0.1.119", operator_confirmed=operator_confirmed,
    ...
    return {
        ...
        "repository_version": __version__, "latest_recorded_farm5_sync_evidence": "0.1.119", "farm5_0_1_119_sync_evidence_present": "synced to 0.1.119" in phase_status,
        "farm5_0_1_120_sync_required_before_farm5_dry_run_evidence": True, "current_state_preserved": "current_accepted_phase: Phase 7" in phase_status,
        ...
        "future_farm5_dry_run_evidence_requires_0_1_120_sync": True, "future_phase8_final_acceptance_pr_required": True,
