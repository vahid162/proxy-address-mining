...
def build_phase9_final_acceptance_readiness_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
    ...
    gate_ok = (
        "current_accepted_phase: Phase 8 — Abuse 1h Core accepted on farm5" in phase
        and "current_working_phase: Phase 9 — Check / Report / Diagnostics planning/readiness" in phase
    )
    farm5_0_1_126_present = "### Phase 9 farm5 0.1.126 Sync/Test Evidence" in phase and "server version after sync:\n  0.1.126" in phase
    ...
    report = {
        ...
        "latest_recorded_farm5_sync_evidence": "0.1.126" if farm5_0_1_126_present else "unknown",
        "farm5_0_1_126_sync_test_evidence_present": farm5_0_1_126_present,
        ...
        "next_required_operator_evidence": "fresh farm5 0.1.127 sync/test evidence required after merge before Phase 9 final acceptance",
    }
    ...
    if not farm5_0_1_126_present:
        blockers.append("farm5_0_1_126_sync_test_evidence_missing")
