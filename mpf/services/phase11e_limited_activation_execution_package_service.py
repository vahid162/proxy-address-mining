...
def build_phase11e_limited_activation_execution_package_report(config: MPFConfig, **k: object)->dict[str,object]:
    ...
    ready=not b
    ops=["REVIEW_ONLY_PLACEHOLDER_DO_NOT_RUN_DIRECTLY","Future gated path (not implemented here): mpf production phase11e-limited-activation-execute --customer-key limited-btc-001 ..."]
