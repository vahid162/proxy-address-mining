...
def build_enforcement_boundary_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
    report = build_phase10_readiness_report(cfg, repo_root=repo_root)
    return {
        "component": "phase10_enforcement_boundary_service",
        "final_decision": report["final_decision"],
        "authorization_status": report["authorization_status"],
        "execution_allowed": report["execution_allowed"],
        "enforcement_boundary_readiness": report["enforcement_boundary_readiness"],
