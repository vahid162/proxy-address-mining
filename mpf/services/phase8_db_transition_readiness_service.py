...
def build_phase8_db_transition_readiness_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
    ...
    bools = {
        ...
        "no_farm5_0_1_114_sync_evidence_claimed": "synced to 0.1.114" not in phase_status,
        ...
        "readme_current_gate_aligned": "DB-only controlled transition readiness package" in readme,
        "index_current_gate_aligned": "DB-only controlled transition readiness" in index,
    ...
    report = {
        ...
        "no_server_sync_evidence_for_0_1_111": bools["no_farm5_0_1_111_sync_evidence_claimed"], "no_server_sync_evidence_for_0_1_112": bools["no_farm5_0_1_112_sync_evidence_claimed"], "no_server_sync_evidence_for_0_1_113": bools["no_farm5_0_1_113_sync_evidence_claimed"], "no_server_sync_evidence_for_0_1_114": bools["no_farm5_0_1_114_sync_evidence_claimed"],
