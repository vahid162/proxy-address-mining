...
def build_restore_lock_record_gate_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
    ...
    proposal_boundary_present = False
    ...
    if not phase_status.exists():
        ...
        if state is None:
            ...
            if state.get("live_snapshot_read_allowed") != "iptables_save_read_only":
        ...
        proposal_boundary_present = "Phase 6 Restore/Lock/DB Apply Record Gate — Proposal Boundary" in text
        if not proposal_boundary_present:
    ...
    return {
        ...
        "gate_status": "PROPOSAL_BOUNDARY_DEFINED",
        "authorization_status": "NOT_ACCEPTED",
        "inspection_only": True,
        "report_only": True,
        "preflight_only": True,
        "current_state_preserved": current_state_preserved,
        "proposal_boundary_present": proposal_boundary_present,
        ...
        "abuse_automation_allowed": "no",
        "live_snapshot_read_allowed": "iptables_save_read_only",
        "future_restore_point_gate_defined": proposal_boundary_present,
        "future_lock_gate_defined": proposal_boundary_present,
        "future_db_apply_record_gate_defined": proposal_boundary_present,
        "restore_point_write_allowed": False,
        "restore_point_written": False,
        "restore_point_artifact_written": False,
        ...
        "live_firewall_read_allowed": True,
        "live_firewall_read_executed": False,
        "iptables_save_allowed": True,
        ...
        "time_sync_status_checked": False,
        ...
        "next_required_gate": "explicit acceptance for controlled restore point + lock + DB apply record behavior with farm5 evidence",
        "blockers": blockers,
        "warnings": warnings,
        "errors": errors,
    }
