...
def build_no_customer_apply_execution_acceptance_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
 ...
 "no_customer_nat":True,"no_customer_firewall_rules":True,"no_production_traffic":True,"no_usage_automation":True,"no_abuse_automation":True,"separate_operator_runtime_execution_approval_required":False,"fresh_farm5_runtime_execution_evidence_required":False,"explicit_rollback_evidence_required":False,"explicit_verify_evidence_required":False}
