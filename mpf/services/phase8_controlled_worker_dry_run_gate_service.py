...
def build_phase8_controlled_worker_dry_run_gate_report(cfg: MPFConfig, repo_root: Path | None = None) -> dict[str, object]:
    ...
    checks = {
        ...
        "farm5_0_1_121_sync_evidence_present": "Phase 8 farm5 0.1.121 Dry-Run Evidence Collection Sync Evidence" in phase_status and "synced to 0.1.121" in phase_status,
        "farm5_0_1_121_sync_evidence_aligned": "0.1.121" in phase_status,
    ...
    bool_true = {
        ...
        "future_controlled_worker_dry_run_requires_operator": True, "future_controlled_worker_dry_run_requires_0_1_122_sync": True,
    ...
    checklist_names = [
        "current_state_preserved","phase7_accepted","phase8_working","phase8_not_accepted","farm5_0_1_121_sync_evidence_present",
        "farm5_0_1_121_sync_evidence_aligned","controlled_worker_dry_run_gate_doc_present","controlled_worker_dry_run_gate_prepared",
    ...
    return {
        ...
        "repository_version": __version__, "latest_recorded_farm5_sync_evidence": "0.1.121",
