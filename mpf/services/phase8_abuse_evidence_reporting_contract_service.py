...
def build_phase8_abuse_evidence_reporting_contract_report(
    ...
    bools = {
        ...
        "readme_current_gate_aligned": "accepted_phase: Phase 7 — Usage + Policy/Reject Accounting accepted on farm5" in readme,
        "index_current_gate_aligned": "Phase 8 step" in index and "evidence/reporting contract" in index,
