...
def build_package_from_plan(plan: dict[str, object]) -> dict[str, object]:
    ...
    no_reapply_ready = plan.get("final_decision") == NO_REAPPLY and not plan.get("blockers")
    missing_delta = []
