...
## 0.1.116
- Fix Phase 8 DB-only transition execution checklist to emit named safety items (not numeric placeholders) while keeping all runtime/firewall/customer gates closed.

## 0.1.115
- Add the Phase 8 DB-only controlled transition execution package with manual confirmation, idempotency, operator approval validation, dry-run default CLI, and farm5 0.1.114 evidence recording while keeping runtime, firewall, customer, and abuse automation gates closed.
...
- kept gate-review and apply-gate-readiness BLOCKED under the current Phase 5 accepted / Phase 6 working gate
- surfaced apply gate readiness blockers and missing requirements in review output
- confirmed no live firewall read/write/apply/rollback/verify, iptables-save, iptables-restore, subprocess firewall calls, real adapters, restore point writes, locks, DB writes, migrations, NAT/customer firewall rules, production traffic, usage automation, abuse automation, UI, or Telegram behavior introduced
...
- indexed Slice 4 document and advanced next operational step to batch server sync/review
- preserved Phase 5 accepted / Phase 6 working gate
- confirmed no manual canary apply, no-customer apply, live firewall read/write/apply/rollback/verify, iptables-save, iptables-restore, real adapters, subprocess firewall calls, restore point writes, locks, DB apply writes, migrations, NAT/customer firewall rules, production traffic, usage automation, abuse automation, UI, or Telegram behavior introduced
- preserved abuse 1h invariant

## 0.1.85 - 2026-05-13

- added concise Apply Slice 3 controlled no-customer harness contract
- indexed Slice 3 document and advanced next planned sub-step to Slice 4
- preserved Phase 5 accepted / Phase 6 working gate
...
- cleaned Phase 6-H index placement before merge
- no live behavior introduced
...
- updated PHASE_STATUS accepted results and future dedicated apply-gate warning
- indexed docs/PHASE_6_G_ACCEPTANCE_EVIDENCE.md
- preserved Phase 5 accepted / Phase 6 working gate
- confirmed no live firewall reads/writes, live apply/rollback/verify, iptables-save, iptables-restore, real iptables adapters, NAT, runtime customer traffic, DB apply writes, locks, restore points, usage, abuse automation, UI, or Telegram behavior was introduced
- preserved abuse 1h invariant
...
- indexed docs/PHASE_6_G_CONTROLLED_LIVE_APPLY_GATE_PLANNING.md
- aligned Phase 6 docs to Phase 6-F accepted / Phase 6-G planned
- kept Phase 6-G documentation/test-only and non-authorizing until a separate apply gate is explicitly accepted
- preserved Phase 5 accepted / Phase 6 working gate
...
- updated PHASE_STATUS accepted results and next planned Phase 6-E0
- indexed docs/PHASE_6_D1_ACCEPTANCE_EVIDENCE.md
- preserved Phase 5 accepted / Phase 6 working gate
...
- updated `README.md`, `AGENTS.md`, `docs/INDEX.md`, `docs/AI_CODING_RULES.md`, and `docs/AI_PHASE_6_TASK.md` to describe Phase 6-B as offline, artifact-only, inspection-only, and non-mutating.
- kept Phase 5 accepted / Phase 6 working gate unchanged.
- confirmed no live firewall reads/writes, iptables-save, iptables-restore, NAT, runtime, usage, abuse, UI, or Telegram behavior was introduced.
