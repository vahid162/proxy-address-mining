...
## 0.1.138
- Align stale current-state documentation to Phase 10 accepted / Phase 11 Production Customer Activation Gate planning-readiness, refresh active AI-agent guidance, and keep production activation, controlled CLI canary, firewall, runtime, abuse automation, UI, and Telegram gates closed.
