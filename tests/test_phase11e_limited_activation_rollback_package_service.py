...
def test_ready(tmp_path):
 ...
 r=build_phase11e_limited_activation_rollback_package_report(cfg(),expected_version='0.1.227',limited_activation_decision_json=p,limited_activation_decision_json_sha256=s,operator='o',reason='r',operator_confirmed=True,i_understand_rollback_package_only=True,i_understand_no_rollback_performed=True,i_understand_no_db_mutation=True,i_understand_no_firewall_apply=True)
