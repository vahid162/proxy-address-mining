...
def test_ready_path(tmp_path):
 r=run(tmp_path); assert r['final_decision']=='PHASE11_POST_ACCEPTANCE_VERIFICATION_READY'; assert r['artifact_gate_passed'] is True; assert r['phase11_operational_completion_required'] is True; assert r['phase12_start_allowed']=='no'; assert r['abuse_automation_allowed']=='controlled_operator_gated'; assert r['next_required_step']=='implement_controlled_abuse_operational_core'
