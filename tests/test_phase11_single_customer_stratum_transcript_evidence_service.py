...
def test_expected_version_override_works_for_current_version(tmp_path):
    ...
    r = svc.build_phase11_single_customer_stratum_transcript_evidence_report(_cfg(), transcript_json=p, expected_version="0.1.215")
    assert r['expected_version'] == "0.1.215"
