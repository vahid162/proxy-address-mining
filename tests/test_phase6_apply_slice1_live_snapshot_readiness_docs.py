...
def test_readme_and_phase_status_next_step_wording():
    assert "Apply Slice 1 as the planned documentation/test-only non-authorizing next sub-step" in README
    ...
    assert "Apply Slice 1 — Live Snapshot Readiness Boundary" in PHASE_STATUS
