...
def test_phase10_readiness_fail_closed_missing_evidence(tmp_path: Path):
    ...
    assert "farm5_0_1_131_sync_test_evidence_missing" in r["blockers"]
...
def test_phase10_cli_json():
    ...
    assert data["latest_recorded_farm5_sync_evidence"] == "0.1.131"
