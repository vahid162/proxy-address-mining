...
def test_service_and_cli() -> None:
    ...
    assert r["repository_version"] == "0.1.120"
    assert r["latest_recorded_farm5_sync_evidence"] == "0.1.119"
    assert r["farm5_0_1_119_sync_evidence_present"] is True
    assert r["farm5_0_1_120_sync_required_before_farm5_dry_run_evidence"] is True
    ...
    assert data["farm5_0_1_119_sync_evidence_present"] is True
    assert data["farm5_0_1_120_sync_required_before_farm5_dry_run_evidence"] is True
