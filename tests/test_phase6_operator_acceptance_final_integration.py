...
def test_phase6_operator_acceptance_final_integration() -> None:
    ...
    assert s["phase6_operator_acceptance_decision_final_decision"] == "BLOCKED"
    assert s["phase6_operator_acceptance_decision_phase6_accepted"] in {True, False}
    ...
    assert grj["apply_gate_readiness_summary"]["phase6_operator_acceptance_decision_summary"]["phase6_operator_acceptance_decision_phase7_start_allowed"] in {True, False}
