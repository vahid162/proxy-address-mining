...
def test_ready_report_emits_generated_evidence():
    ...
    r = build_phase11_canary_final_check_report_visibility_report(_cfg(), customer_key="canary-btc-001", lane="btc", port=20001, expected_version="0.1.194", farm5_baseline_version="0.1.168", evidence=ev)
