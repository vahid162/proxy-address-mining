...
def test_gap_inventory_cli_returns_fail_closed_json() -> None:
    ...
    assert report["repository_version"] == "0.1.283"
    assert report["final_decision"] == "PHASE11_FULL_CLI_PRODUCTION_OPERATIONS_REQUIRED"
    assert report["phase12_start_allowed"] is False
...
def test_gap_inventory_cli_accepts_packet_path_evidence_dir(monkeypatch, tmp_path) -> None:
    ...
    def fake_run(config_path, *, evidence_dir=None, packet_path_evidence_dir=None, lifecycle_execution_evidence_json=None, firewall_completion_evidence_dir=None):
        ...
        return {"component": "phase11_operational_completion_gap_inventory", "repository_version": "0.1.283", "final_decision": "PHASE11_FULL_CLI_PRODUCTION_OPERATIONS_REQUIRED", "phase12_start_allowed": False, "mutation_performed": False, "next_required_step": "sync_and_review_live_ready_controlled_artifact_reapply_package_on_farm5"}
