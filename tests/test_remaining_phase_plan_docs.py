...
def test_current_position_single_and_targets() -> None:
    ...
    assert "- GitHub main repository version before this PR is 0.1.132." in current
    assert "- Repository version after this PR is 0.1.133." in current
    assert "- latest recorded farm5 sync evidence is 0.1.132." in current
