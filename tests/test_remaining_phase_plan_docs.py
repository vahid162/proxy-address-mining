...
def test_current_position_updates() -> None:
    ...
    assert "- Repository version after this PR is 0.1.207." in current
    ...
    assert "- after 0.1.207 sync and full pytest, next intended farm5 step is runtime path evidence collection/classification for 20101." in current
