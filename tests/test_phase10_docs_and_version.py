...
def test_version_0_1_141_consistency():
    assert Path("VERSION").read_text().strip() == "0.1.141"
    assert __version__ == "0.1.141"
    assert 'version = "0.1.141"' in Path("pyproject.toml").read_text(encoding="utf-8")
