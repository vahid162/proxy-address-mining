...
def test_version_0_1_144_consistency():
    assert Path("VERSION").read_text().strip() == "0.1.144"
    assert __version__ == "0.1.144"
    assert 'version = "0.1.144"' in Path("pyproject.toml").read_text(encoding="utf-8")
