...
def test_version_0_1_130_consistency():
    assert Path('VERSION').read_text().strip() == '0.1.130'
    assert __version__ == '0.1.130'
    assert 'version = "0.1.130"' in Path('pyproject.toml').read_text(encoding='utf-8')
