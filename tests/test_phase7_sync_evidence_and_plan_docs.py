...
def test_remaining_plan_targets_updated() -> None:
    ...
    assert "GitHub main repository version before this PR is 0.1.123" in text
    assert "Repository version after this PR is 0.1.124" in text
    assert "latest recorded farm5 sync evidence is 0.1.123" in text
