...
def test_phase_status_reflects_phase5_acceptance_and_phase6_working_gate() -> None:
    ...
    assert "current_accepted_phase: Phase 5 — Customer CRUD in DB Only accepted on farm5" in status_text
    assert "current_working_phase: Phase 6 — Firewall Planner" in status_text
