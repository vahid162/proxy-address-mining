...
def test_docs_regression_phase6_operator_acceptance() -> None:
    ...
    assert 'current_accepted_phase: Phase 9 — Check / Report / Diagnostics accepted on farm5' in ps
    assert 'current_working_phase: Phase 10 — Session / Worker / Policy / Share Timeline planning/readiness' in ps
