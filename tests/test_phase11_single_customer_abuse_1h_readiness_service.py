...
def test_accepts_source_visibility_0218_and_ready(tmp_path):
 ...
 assert r['final_decision'].endswith('READY') and r['repository_version']=='0.1.277' and r['source_visibility_bundle_repository_version']=='0.1.218'
