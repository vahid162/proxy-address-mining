...
grep -q 'current_accepted_phase: Phase 8 — Abuse 1h Core accepted on farm5' docs/PHASE_STATUS.md || fail 'docs/PHASE_STATUS.md does not show accepted Phase 8 gate'
grep -q 'current_working_phase: Phase 9 — Check / Report / Diagnostics planning/readiness' docs/PHASE_STATUS.md || fail 'docs/PHASE_STATUS.md does not show Phase 9 planning/readiness as current working phase'
...
printf '%s\n' "$phase_status_output"
[[ "$phase_status_output" == *'current_accepted_phase: Phase 8 — Abuse 1h Core accepted on farm5'* ]] || fail 'mpf phase-status is not aligned with accepted Phase 8 gate'
[[ "$phase_status_output" == *'current_working_phase: Phase 9 — Check / Report / Diagnostics planning/readiness'* ]] || fail 'mpf phase-status is not aligned with Phase 9 planning/readiness'
