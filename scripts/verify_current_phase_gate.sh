...
# historical compatibility anchor: accepted Phase 9 / Phase 10 planning/readiness (stale/non-authorizing)
...
grep -q 'current_accepted_phase: Phase 10 — Session / Worker / Policy / Share Timeline accepted on farm5' docs/PHASE_STATUS.md || fail 'docs/PHASE_STATUS.md does not show accepted Phase 10 gate'
grep -q 'current_working_phase: Phase 11 — Production / Customer Activation Gate planning/readiness' docs/PHASE_STATUS.md || fail 'docs/PHASE_STATUS.md does not show Phase 11 planning/readiness as current working phase'
...
printf '%s\n' "$phase_status_output"
[[ "$phase_status_output" == *'current_accepted_phase: Phase 10 — Session / Worker / Policy / Share Timeline accepted on farm5'* ]] || fail 'mpf phase-status is not aligned with accepted Phase 10 gate'
[[ "$phase_status_output" == *'current_working_phase: Phase 11 — Production / Customer Activation Gate planning/readiness'* ]] || fail 'mpf phase-status is not aligned with Phase 11 planning/readiness'
