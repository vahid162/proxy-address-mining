...
grep -q 'current_accepted_phase: Phase 7 — Usage + Policy/Reject Accounting accepted on farm5' docs/PHASE_STATUS.md || fail 'docs/PHASE_STATUS.md does not show accepted Phase 5 DB-only customer CRUD gate'
grep -q 'current_working_phase: Phase 8 — Abuse 1h Core planning/readiness' docs/PHASE_STATUS.md || fail 'docs/PHASE_STATUS.md does not show Phase 6 as current working phase'
...
printf '%s\n' "$phase_status_output"
[[ "$phase_status_output" == *'current_accepted_phase: Phase 7 — Usage + Policy/Reject Accounting accepted on farm5'* ]] || fail 'mpf phase-status is not aligned with accepted Phase 5 gate'
[[ "$phase_status_output" == *'current_working_phase: Phase 8 — Abuse 1h Core planning/readiness'* ]] || fail 'mpf phase-status is not aligned with Phase 6'
